  ...
  return (
    ...
    <nav class="bg-secondary h-screen flex items-center justify-center ">
      <ul class="h-[100%] max-h-[300px] flex flex-col items-center text-center justify-around">
        ...
        <li><a class="text-primary font-sans font-bold text-navLinks " href="/#consulta">Consulta</a></li>
        <li><a class="text-primary font-sans font-bold text-navLinks " href="/about">Sobre mi</a></li>
